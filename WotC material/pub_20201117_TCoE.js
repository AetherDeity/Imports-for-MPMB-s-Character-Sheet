...
AddSubClass("bard", "college of eloquence-tcoe", {
	...
	features : {
		"subclassfeature3" : {
			...
			minlevel : 3,
			description : desc([
				"When I make a Charisma (Persuation) or Charisma (Deception) check, you can treat a d20 roll of 9 or lower as a 10"
			]),
		},
		"subclassfeature3.1" : {
			...
			action : ["bonus action", ""],
			description : desc([
				"As a bonus action, I expend one Bardic Inspiration die to instill doubt in a creature within 60 ft of me",
				"The creature subracts the roll from its next saving throw before the start of my next turn"
			])
		},
		"subclassfeature6" : {
			...
			minlevel : 6,
			description : desc([
				"When a creature uses my Bardic Inspiration die and fails, they keep the die"
			]),
		},
		"subclassfeature6.1" : {
		...
		"subclassfeature14" : {
			...
			action : ["reaction", ""],
			description : desc([
				"As a reaction, when a creature within 60 ft of me succeeds on a check when using my Inspiration die",
				"I can inspire another creature within 60 ft of me that can hear me without expending a Bardic Inspiration"
			])
		}
	}
});
